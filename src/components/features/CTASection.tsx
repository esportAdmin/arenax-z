      ...
      <div className="container-arena relative">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card mb-8">
            ...
            <span className="text-sm font-medium">Ready to compete?</span>
          </div>

          <h2 className="font-display font-black text-4xl md:text-5xl lg:text-6xl mb-6">
            <span className="text-foreground">Enter The </span>
            <span className="gradient-text-primary text-glow-cyan">Arena</span>
          </h2>

          <p className="text-lg text-muted-foreground mb-10 max-w-xl mx-auto">
            Join thousands of fans already earning rewards through predictions,
            staking, and community engagement. Your esports journey starts now.
          </p>
